...
"}")
        ...
        self.spin_stoploss.setGeometry(QRect(110, 254, 131, 31))
        palette2 = QPalette()
...
"")
        ...
        self.label_call_delta = QLabel(self.MainWinodw2)
        self.label_call_delta.setObjectName(u"label_call_delta")
        self.label_call_delta.setGeometry(QRect(150, 202, 81, 16))
        self.label_call_delta.setFont(font7)
        self.label_call_delta.setStyleSheet(u"color:white")
        self.label_label_put_delta = QLabel(self.MainWinodw2)
        self.label_label_put_delta.setObjectName(u"label_label_put_delta")
        self.label_label_put_delta.setGeometry(QRect(250, 182, 61, 13))
        self.label_label_put_delta.setFont(font2)
        self.label_label_put_delta.setStyleSheet(u"color:#9F9F9F")
        self.label_put_delta = QLabel(self.MainWinodw2)
        self.label_put_delta.setObjectName(u"label_put_delta")
        self.label_put_delta.setGeometry(QRect(250, 202, 81, 16))
        self.label_put_delta.setFont(font7)
        self.label_put_delta.setStyleSheet(u"color:white")
        self.label_spot_2 = QLabel(self.MainWinodw2)
        self.label_spot_2.setObjectName(u"label_spot_2")
        self.label_spot_2.setGeometry(QRect(30, 202, 81, 16))
        self.label_spot_2.setFont(font7)
        self.label_spot_2.setStyleSheet(u"color:white")
        ...
        self.label_call_delta.raise_()
        self.label_label_put_delta.raise_()
        self.label_put_delta.raise_()
        self.label_spot_2.raise_()
    ...
    def retranslateUi(self, main):
        ...
        self.label_call_delta.setText(QCoreApplication.translate("main", u"0.0", None))
        self.label_label_put_delta.setText(QCoreApplication.translate("main", u"Put Delta", None))
        self.label_put_delta.setText(QCoreApplication.translate("main", u"0.0", None))
        self.label_spot_2.setText(QCoreApplication.translate("main", u"0.0", None))
