...
"}")
        ...
        self.label_label_futures.setGeometry(QRect(150, 130, 58, 13))
...
"}")
        ...
        self.label_virtualtrading = QLabel(self.MainWinodw2)
        self.label_virtualtrading.setObjectName(u"label_virtualtrading")
        self.label_virtualtrading.setGeometry(QRect(224, 472, 97, 17))
        font13 = QFont()
        font13.setPointSize(10)
        self.label_virtualtrading.setFont(font13)
        self.label_virtualtrading.setStyleSheet(u"color:#9F9F9F")
        self.label_virtualtrading.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.label_virtualtrading.raise_()
    ...
    def retranslateUi(self, main):
        ...
        self.label_label_futures.setText(QCoreApplication.translate("main", u"Call Strike", None))
        self.label_future_diff.setText(QCoreApplication.translate("main", u"0.0", None))
        self.label_label_futures_diff.setText(QCoreApplication.translate("main", u"Put Strike", None))
        ...
        self.label_profit.setText(QCoreApplication.translate("main", u"+10,900 / 30 pt", None))
        self.label_risk.setText(QCoreApplication.translate("main", u"10,900 | +20", None))
        ...
        self.label_virtualtrading.setText(QCoreApplication.translate("main", u"Virtual Trading", None))
    # retranslateUi
