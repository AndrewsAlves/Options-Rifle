...
class Ui_main(object):
    def setupUi(self, main):
        ...
        main.resize(357, 786)
        main.setMinimumSize(QSize(357, 786))
        ...
        self.btn_defensive.setFont(font)
        ...
        self.spinner_ticker.setFont(font)
...
"")
        ...
        self.label_riskpertrade.setGeometry(QRect(30, 699, 80, 16))
        self.label_riskpertrade.setFont(font)
        ...
        self.et_risk.setGeometry(QRect(30, 719, 91, 21))
        self.et_risk.setFont(font)
...
"border-color:black;")
        ...
        self.label_mtm_label.setGeometry(QRect(280, 625, 41, 21))
        font2 = QFont()
        ...
        self.label_MTM.setGeometry(QRect(80, 646, 241, 31))
        font3 = QFont()
        ...
        self.btn_execute.setGeometry(QRect(230, 712, 91, 31))
        palette1 = QPalette()
        ...
        self.btn_execute.setFont(font1)
...
" background: #F3EF52")
        ...
        self.line_2.setGeometry(QRect(29, 599, 291, 16))
        ...
        self.label_label_spot.setFont(font)
        ...
        font4 = QFont()
        font4.setFamilies([u"Graphie"])
        font4.setPointSize(11)
        font4.setBold(False)
        self.label_spot.setFont(font4)
        ...
        self.label_futures.setFont(font4)
        ...
        self.label_label_futures.setFont(font)
        ...
        font5 = QFont()
        font5.setFamilies([u"Graphie"])
        font5.setPointSize(11)
        self.label_future_diff.setFont(font5)
        ...
        self.label_label_futures_diff.setFont(font)
        ...
        self.label_stoploss.setGeometry(QRect(151, 250, 47, 13))
        self.label_stoploss.setFont(font)
        ...
        self.label_trades.setStyleSheet(u"color:#F3EF52")
        self.btn_editrisk = QPushButton(self.MainWinodw2)
        self.btn_editrisk.setObjectName(u"btn_editrisk")
        self.btn_editrisk.setGeometry(QRect(130, 720, 21, 21))
        self.btn_editrisk.setFont(font1)
        ...
        self.frame_trade.setGeometry(QRect(30, 350, 291, 241))
        ...
        icon = QIcon()
        icon.addFile(u"../icons/icon_arrow_long.png", QSize(), QIcon.Normal, QIcon.Off)
        self.icon_trade_type.setIcon(icon)
        ...
        self.label_instrument.setGeometry(QRect(40, 40, 221, 16))
        font6 = QFont()
        font6.setFamilies([u"Graphie"])
        ...
        self.border_label.setGeometry(QRect(0, 0, 291, 241))
...
"border: 2px solid #FFFFFF;")
        ...
        self.label_label_qty.setGeometry(QRect(53, 68, 21, 16))
        self.label_label_qty.setFont(font)
        ...
        self.label_label_avg.setGeometry(QRect(134, 68, 21, 16))
        self.label_label_avg.setFont(font)
        self.label_label_avg.setStyleSheet(u"color:#9F9F9F")
        self.label_3 = QLabel(self.frame_trade)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(216, 68, 21, 16))
        ...
        self.label_trade_qty.setGeometry(QRect(31, 88, 61, 16))
        font7 = QFont()
        font7.setFamilies([u"Graphie"])
        font7.setPointSize(11)
        font7.setBold(True)
        self.label_trade_qty.setFont(font7)
        self.label_trade_qty.setStyleSheet(u"color:#40ADF5")
        ...
        self.label_avg_price.setGeometry(QRect(114, 88, 61, 16))
        ...
        self.label_trade_ltp.setGeometry(QRect(196, 88, 61, 16))
        ...
        self.label_strategy.setGeometry(QRect(25, 4, 31, 31))
        font8 = QFont()
        font8.setFamilies([u"Graphie"])
        ...
        self.spin_sl = QSpinBox(self.frame_trade)
        self.spin_sl.setObjectName(u"spin_sl")
        self.spin_sl.setGeometry(QRect(117, 143, 61, 21))
        self.spin_sl.setAlignment(Qt.AlignCenter)
        self.spin_sl.setReadOnly(False)
        self.spin_sl.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.btn_increase_sl = QPushButton(self.frame_trade)
        self.btn_increase_sl.setObjectName(u"btn_increase_sl")
        self.btn_increase_sl.setGeometry(QRect(183, 142, 21, 23))
        self.btn_increase_sl.setStyleSheet(u"background:rgba(0, 0, 0, 0);")
        icon1 = QIcon()
        icon1.addFile(u"../icons/btn_plus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_increase_sl.setIcon(icon1)
        self.btn_increase_sl.setIconSize(QSize(18, 18))
        self.btn_decrease_sl = QPushButton(self.frame_trade)
        self.btn_decrease_sl.setObjectName(u"btn_decrease_sl")
        self.btn_decrease_sl.setGeometry(QRect(91, 142, 21, 23))
        self.btn_decrease_sl.setStyleSheet(u"background:rgba(0, 0, 0, 0);")
        icon2 = QIcon()
        icon2.addFile(u"../icons/btn_minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_decrease_sl.setIcon(icon2)
        self.btn_decrease_sl.setIconSize(QSize(18, 18))
        self.btn_edit_sl = QPushButton(self.frame_trade)
        self.btn_edit_sl.setObjectName(u"btn_edit_sl")
        self.btn_edit_sl.setGeometry(QRect(136, 169, 23, 23))
        self.btn_edit_sl.setStyleSheet(u"background:rgba(0, 0, 0, 0);")
        icon3 = QIcon()
        icon3.addFile(u"../icons/btn_edit_sl.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_edit_sl.setIcon(icon3)
        self.btn_edit_sl.setIconSize(QSize(18, 18))
        self.label = QLabel(self.frame_trade)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(138, 120, 16, 21))
        font9 = QFont()
        font9.setFamilies([u"Graphie"])
        ...
        self.label_profit.setGeometry(QRect(148, 204, 131, 31))
        self.label_profit.setFont(font2)
        ...
        self.label_risk.setGeometry(QRect(9, 204, 131, 31))
        self.label_risk.setFont(font2)
        ...
        self.label_label_risk.setGeometry(QRect(10, 190, 47, 13))
        self.label_label_risk.setFont(font)
        ...
        self.label_label_profit.setGeometry(QRect(229, 190, 47, 13))
        self.label_label_profit.setFont(font)
        ...
        self.label_order_status = QLabel(self.frame_trade)
        self.label_order_status.setObjectName(u"label_order_status")
        self.label_order_status.setGeometry(QRect(111, 10, 71, 16))
        self.label_order_status.setFont(font6)
        self.label_order_status.setStyleSheet(u"color:#0DFF00")
        self.label_order_status.setAlignment(Qt.AlignCenter)
        self.btn_exit_trade = QPushButton(self.frame_trade)
        self.btn_exit_trade.setObjectName(u"btn_exit_trade")
        self.btn_exit_trade.setGeometry(QRect(239, 6, 46, 25))
        self.btn_exit_trade.setFont(font)
        self.btn_exit_trade.setStyleSheet(u"background:rgba(0, 0, 0, 0);")
        icon4 = QIcon()
        icon4.addFile(u"../icons/btn_exit.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_exit_trade.setIcon(icon4)
        self.btn_exit_trade.setIconSize(QSize(43, 43))
        ...
        self.label_order_status.raise_()
        self.btn_exit_trade.raise_()
        self.label_no_position = QLabel(self.MainWinodw2)
        self.label_no_position.setObjectName(u"label_no_position")
        self.label_no_position.setGeometry(QRect(106, 460, 145, 16))
        self.label_no_position.setFont(font)
    ...
    def retranslateUi(self, main):
        ...
        self.label_trades.setText(QCoreApplication.translate("main", u"Position", None))
        self.btn_editrisk.setText("")
        self.btn_trans_label_Fut.setText("")
        self.icon_trade_type.setText("")
        self.label_instrument.setText(QCoreApplication.translate("main", u"BANKNIFTY 16 MAR 23 45000 CE", None))
        ...
        self.label_order_status.setText(QCoreApplication.translate("main", u"Pending...", None))
        self.btn_exit_trade.setText("")
