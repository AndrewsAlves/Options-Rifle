...
" background: #F3EF52")
        ...
        self.frame_disable = QFrame(self.MainWinodw2)
        self.frame_disable.setObjectName(u"frame_disable")
        self.frame_disable.setEnabled(True)
        self.frame_disable.setGeometry(QRect(-40, -20, 411, 931))
        self.frame_disable.setStyleSheet(u"background:rgba(0, 0, 0, 100);")
        self.frame_disable.setFrameShape(QFrame.StyledPanel)
        self.frame_disable.setFrameShadow(QFrame.Plain)
