...
################################################################################
## Form generated from reading UI file 'options_rifle_UI_1.5.ui'
##
...
class Ui_main(object):
    def setupUi(self, main):
        ...
        main.resize(357, 945)
        main.setMinimumSize(QSize(357, 945))
        main.setMaximumSize(QSize(357, 950))
        font = QFont()
        ...
        self.spinner_ticker.setGeometry(QRect(30, 80, 120, 31))
...
"}")
        ...
        self.spin_stoploss.setGeometry(QRect(186, 190, 131, 31))
        palette2 = QPalette()
        ...
        self.label_stoploss.setGeometry(QRect(220, 229, 59, 16))
        self.label_stoploss.setFont(font2)
        self.label_stoploss.setStyleSheet(u"color:#9F9F9F")
...
"    }")
        ...
        self.btn_auto_trail.setGeometry(QRect(4, 2, 21, 30))
        self.btn_auto_trail.setStyleSheet(u"background:rgba(0, 0, 0, 0);")
        self.btn_auto_trail.setIcon(icon4)
        self.btn_auto_trail.setIconSize(QSize(20, 20))
...
"}")
        ...
        self.spinner_ticker_2 = QComboBox(self.MainWinodw2)
        self.spinner_ticker_2.setObjectName(u"spinner_ticker_2")
        self.spinner_ticker_2.setGeometry(QRect(159, 80, 82, 31))
        self.spinner_ticker_2.setFont(font2)
        self.spinner_ticker_2.setStyleSheet(u"color:#F3EF52;\n"
"")
        self.spinner_ticker_2.setMaxVisibleItems(10)
        self.spinner_ticker_2.setMaxCount(2147483646)
        self.spin_stoploss_2 = QSpinBox(self.MainWinodw2)
        self.spin_stoploss_2.setObjectName(u"spin_stoploss_2")
        self.spin_stoploss_2.setGeometry(QRect(35, 190, 131, 31))
        palette4 = QPalette()
        ...
        palette4.setBrush(QPalette.Active, QPalette.Link, brush2)
        ...
        palette4.setBrush(QPalette.Inactive, QPalette.Link, brush2)
        ...
        palette4.setBrush(QPalette.Disabled, QPalette.Link, brush2)
        self.spin_stoploss_2.setPalette(palette4)
        self.spin_stoploss_2.setFont(font4)
        self.spin_stoploss_2.setStyleSheet(u"color:white;")
        self.spin_stoploss_2.setAlignment(Qt.AlignCenter)
        self.spin_stoploss_2.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_stoploss_2.setMaximum(1000000)
        self.label_stoploss_2 = QLabel(self.MainWinodw2)
        self.label_stoploss_2.setObjectName(u"label_stoploss_2")
        self.label_stoploss_2.setGeometry(QRect(71, 229, 59, 16))
        self.label_stoploss_2.setFont(font2)
        self.label_stoploss_2.setStyleSheet(u"color:#9F9F9F")
        self.label_stoploss_2.setAlignment(Qt.AlignCenter)
        self.line_4 = QFrame(self.MainWinodw2)
        self.line_4.setObjectName(u"line_4")
        self.line_4.setGeometry(QRect(175, 310, 3, 150))
        self.line_4.setFrameShape(QFrame.VLine)
        self.line_4.setFrameShadow(QFrame.Sunken)
        self.btn_add_trade = QPushButton(self.MainWinodw2)
        self.btn_add_trade.setObjectName(u"btn_add_trade")
        self.btn_add_trade.setGeometry(QRect(157, 249, 39, 25))
        palette5 = QPalette()
        ...
        self.btn_add_trade.setPalette(palette5)
        self.btn_add_trade.setFont(font6)
        self.btn_add_trade.setStyleSheet(u"QPushButton  {\n"
"  font-size:12px;\n"
"  width:140px;\n"
"  height:50px;\n"
"  border-width:1px;\n"
...
"}")
        icon5 = QIcon()
        icon5.addFile(u"../../icons/icon_add_trade.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_add_trade.setIcon(icon5)
        self.btn_add_trade.setIconSize(QSize(22, 22))
        self.btn_add_trade.setAutoDefault(False)
        self.btn_add_trade.setFlat(False)
        self.label_label_spot_2 = QLabel(self.MainWinodw2)
        self.label_label_spot_2.setObjectName(u"label_label_spot_2")
        self.label_label_spot_2.setGeometry(QRect(85, 285, 27, 13))
        self.label_label_spot_2.setFont(font2)
        self.label_label_spot_2.setStyleSheet(u"color:#9F9F9F")
        self.label_label_spot_3 = QLabel(self.MainWinodw2)
        self.label_label_spot_3.setObjectName(u"label_label_spot_3")
        self.label_label_spot_3.setGeometry(QRect(237, 285, 31, 13))
        self.label_label_spot_3.setFont(font2)
        self.label_label_spot_3.setStyleSheet(u"color:#9F9F9F")
        self.line_5 = QFrame(self.MainWinodw2)
        self.line_5.setObjectName(u"line_5")
        self.line_5.setGeometry(QRect(30, 865, 291, 16))
        self.line_5.setFrameShape(QFrame.HLine)
        self.line_5.setFrameShadow(QFrame.Sunken)
        self.frame_long_1 = QFrame(self.MainWinodw2)
        self.frame_long_1.setObjectName(u"frame_long_1")
        self.frame_long_1.setGeometry(QRect(34, 313, 132, 27))
        self.frame_long_1.setFrameShape(QFrame.StyledPanel)
        self.frame_long_1.setFrameShadow(QFrame.Raised)
        self.border_long_1 = QLabel(self.frame_long_1)
        self.border_long_1.setObjectName(u"border_long_1")
        self.border_long_1.setGeometry(QRect(0, 0, 132, 27))
        self.border_long_1.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #15B211;")
        self.label_long_1 = QLabel(self.frame_long_1)
        self.label_long_1.setObjectName(u"label_long_1")
        self.label_long_1.setGeometry(QRect(10, 2, 49, 21))
        self.label_long_1.setFont(font12)
        self.label_long_1.setStyleSheet(u"color:#15B211")
        self.label_sl_long_1 = QLabel(self.frame_long_1)
        self.label_sl_long_1.setObjectName(u"label_sl_long_1")
        self.label_sl_long_1.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_long_1.setFont(font12)
        self.label_sl_long_1.setStyleSheet(u"color:#15B211")
        self.btn_long_cancel_1 = QPushButton(self.frame_long_1)
        self.btn_long_cancel_1.setObjectName(u"btn_long_cancel_1")
        self.btn_long_cancel_1.setGeometry(QRect(107, 2, 23, 23))
        palette6 = QPalette()
        ...
        self.btn_long_cancel_1.setPalette(palette6)
        self.btn_long_cancel_1.setFont(font6)
        self.btn_long_cancel_1.setStyleSheet(u"  background:#00000000")
        icon6 = QIcon()
        icon6.addFile(u"../../icons/btn_cancel_trade.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_long_cancel_1.setIcon(icon6)
        self.btn_long_cancel_1.setIconSize(QSize(22, 22))
        self.btn_long_cancel_1.setAutoDefault(False)
        self.btn_long_cancel_1.setFlat(False)
        self.frame_long_2 = QFrame(self.MainWinodw2)
        self.frame_long_2.setObjectName(u"frame_long_2")
        self.frame_long_2.setGeometry(QRect(34, 347, 132, 27))
        self.frame_long_2.setFrameShape(QFrame.StyledPanel)
        self.frame_long_2.setFrameShadow(QFrame.Raised)
        self.border_long_2 = QLabel(self.frame_long_2)
        self.border_long_2.setObjectName(u"border_long_2")
        self.border_long_2.setGeometry(QRect(0, 0, 132, 27))
        self.border_long_2.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #15B211;")
        self.label_long_2 = QLabel(self.frame_long_2)
        self.label_long_2.setObjectName(u"label_long_2")
        self.label_long_2.setGeometry(QRect(10, 2, 49, 21))
        self.label_long_2.setFont(font12)
        self.label_long_2.setStyleSheet(u"color:#15B211")
        self.label_sl_long_2 = QLabel(self.frame_long_2)
        self.label_sl_long_2.setObjectName(u"label_sl_long_2")
        self.label_sl_long_2.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_long_2.setFont(font12)
        self.label_sl_long_2.setStyleSheet(u"color:#15B211")
        self.btn_long_cancel_2 = QPushButton(self.frame_long_2)
        self.btn_long_cancel_2.setObjectName(u"btn_long_cancel_2")
        self.btn_long_cancel_2.setGeometry(QRect(107, 2, 23, 23))
        palette7 = QPalette()
        ...
        self.btn_long_cancel_2.setPalette(palette7)
        self.btn_long_cancel_2.setFont(font6)
        self.btn_long_cancel_2.setStyleSheet(u"  background:#00000000")
        self.btn_long_cancel_2.setIcon(icon6)
        self.btn_long_cancel_2.setIconSize(QSize(22, 22))
        self.btn_long_cancel_2.setAutoDefault(False)
        self.btn_long_cancel_2.setFlat(False)
        self.frame_long_3 = QFrame(self.MainWinodw2)
        self.frame_long_3.setObjectName(u"frame_long_3")
        self.frame_long_3.setGeometry(QRect(34, 381, 132, 27))
        self.frame_long_3.setFrameShape(QFrame.StyledPanel)
        self.frame_long_3.setFrameShadow(QFrame.Raised)
        self.border_long_3 = QLabel(self.frame_long_3)
        self.border_long_3.setObjectName(u"border_long_3")
        self.border_long_3.setGeometry(QRect(0, 0, 132, 27))
        self.border_long_3.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #15B211;")
        self.label_long_3 = QLabel(self.frame_long_3)
        self.label_long_3.setObjectName(u"label_long_3")
        self.label_long_3.setGeometry(QRect(10, 2, 49, 21))
        self.label_long_3.setFont(font12)
        self.label_long_3.setStyleSheet(u"color:#15B211")
        self.label_sl_long_3 = QLabel(self.frame_long_3)
        self.label_sl_long_3.setObjectName(u"label_sl_long_3")
        self.label_sl_long_3.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_long_3.setFont(font12)
        self.label_sl_long_3.setStyleSheet(u"color:#15B211")
        self.btn_long_cancel_3 = QPushButton(self.frame_long_3)
        self.btn_long_cancel_3.setObjectName(u"btn_long_cancel_3")
        self.btn_long_cancel_3.setGeometry(QRect(107, 2, 23, 23))
        palette8 = QPalette()
        ...
        self.btn_long_cancel_3.setPalette(palette8)
        self.btn_long_cancel_3.setFont(font6)
        self.btn_long_cancel_3.setStyleSheet(u"  background:#00000000")
        self.btn_long_cancel_3.setIcon(icon6)
        self.btn_long_cancel_3.setIconSize(QSize(22, 22))
        self.btn_long_cancel_3.setAutoDefault(False)
        self.btn_long_cancel_3.setFlat(False)
        self.frame_long_4 = QFrame(self.MainWinodw2)
        self.frame_long_4.setObjectName(u"frame_long_4")
        self.frame_long_4.setGeometry(QRect(34, 415, 132, 27))
        self.frame_long_4.setFrameShape(QFrame.StyledPanel)
        self.frame_long_4.setFrameShadow(QFrame.Raised)
        self.border_long_45 = QLabel(self.frame_long_4)
        self.border_long_45.setObjectName(u"border_long_45")
        self.border_long_45.setGeometry(QRect(0, 0, 132, 27))
        self.border_long_45.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #15B211;")
        self.label_long_5 = QLabel(self.frame_long_4)
        self.label_long_5.setObjectName(u"label_long_5")
        self.label_long_5.setGeometry(QRect(10, 2, 49, 21))
        self.label_long_5.setFont(font12)
        self.label_long_5.setStyleSheet(u"color:#15B211")
        self.label_sl_long_4 = QLabel(self.frame_long_4)
        self.label_sl_long_4.setObjectName(u"label_sl_long_4")
        self.label_sl_long_4.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_long_4.setFont(font12)
        self.label_sl_long_4.setStyleSheet(u"color:#15B211")
        self.btn_long_cancel_5 = QPushButton(self.frame_long_4)
        self.btn_long_cancel_5.setObjectName(u"btn_long_cancel_5")
        self.btn_long_cancel_5.setGeometry(QRect(107, 2, 23, 23))
        palette9 = QPalette()
        ...
        self.btn_long_cancel_5.setPalette(palette9)
        self.btn_long_cancel_5.setFont(font6)
        self.btn_long_cancel_5.setStyleSheet(u"  background:#00000000")
        self.btn_long_cancel_5.setIcon(icon6)
        self.btn_long_cancel_5.setIconSize(QSize(22, 22))
        self.btn_long_cancel_5.setAutoDefault(False)
        self.btn_long_cancel_5.setFlat(False)
        self.frame_short_2 = QFrame(self.MainWinodw2)
        self.frame_short_2.setObjectName(u"frame_short_2")
        self.frame_short_2.setGeometry(QRect(186, 347, 132, 27))
        self.frame_short_2.setFrameShape(QFrame.StyledPanel)
        self.frame_short_2.setFrameShadow(QFrame.Raised)
        self.border_short_2 = QLabel(self.frame_short_2)
        self.border_short_2.setObjectName(u"border_short_2")
        self.border_short_2.setGeometry(QRect(0, 0, 132, 27))
        self.border_short_2.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #E23232;")
        self.label_short_2 = QLabel(self.frame_short_2)
        self.label_short_2.setObjectName(u"label_short_2")
        self.label_short_2.setGeometry(QRect(10, 2, 49, 21))
        self.label_short_2.setFont(font12)
        self.label_short_2.setStyleSheet(u"color:#E23232")
        self.label_sl_short_2 = QLabel(self.frame_short_2)
        self.label_sl_short_2.setObjectName(u"label_sl_short_2")
        self.label_sl_short_2.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_short_2.setFont(font12)
        self.label_sl_short_2.setStyleSheet(u"color:#E23232")
        self.btn_short_cancel_2 = QPushButton(self.frame_short_2)
        self.btn_short_cancel_2.setObjectName(u"btn_short_cancel_2")
        self.btn_short_cancel_2.setGeometry(QRect(107, 2, 23, 23))
        palette10 = QPalette()
        ...
        self.btn_short_cancel_2.setPalette(palette10)
        self.btn_short_cancel_2.setFont(font6)
        self.btn_short_cancel_2.setStyleSheet(u"  background:#00000000")
        self.btn_short_cancel_2.setIcon(icon6)
        self.btn_short_cancel_2.setIconSize(QSize(22, 22))
        self.btn_short_cancel_2.setAutoDefault(False)
        self.btn_short_cancel_2.setFlat(False)
        self.frame_short_1 = QFrame(self.MainWinodw2)
        self.frame_short_1.setObjectName(u"frame_short_1")
        self.frame_short_1.setGeometry(QRect(186, 313, 132, 27))
        self.frame_short_1.setFrameShape(QFrame.StyledPanel)
        self.frame_short_1.setFrameShadow(QFrame.Raised)
        self.border_short_1 = QLabel(self.frame_short_1)
        self.border_short_1.setObjectName(u"border_short_1")
        self.border_short_1.setGeometry(QRect(0, 0, 132, 27))
        self.border_short_1.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #E23232;")
        self.label_short_1 = QLabel(self.frame_short_1)
        self.label_short_1.setObjectName(u"label_short_1")
        self.label_short_1.setGeometry(QRect(10, 2, 49, 21))
        self.label_short_1.setFont(font12)
        self.label_short_1.setStyleSheet(u"color:#E23232")
        self.label_sl_short_1 = QLabel(self.frame_short_1)
        self.label_sl_short_1.setObjectName(u"label_sl_short_1")
        self.label_sl_short_1.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_short_1.setFont(font12)
        self.label_sl_short_1.setStyleSheet(u"color:#E23232")
        self.btn_short_cancel_1 = QPushButton(self.frame_short_1)
        self.btn_short_cancel_1.setObjectName(u"btn_short_cancel_1")
        self.btn_short_cancel_1.setGeometry(QRect(107, 2, 23, 23))
        palette11 = QPalette()
        ...
        self.btn_short_cancel_1.setPalette(palette11)
        self.btn_short_cancel_1.setFont(font6)
        self.btn_short_cancel_1.setStyleSheet(u"  background:#00000000")
        self.btn_short_cancel_1.setIcon(icon6)
        self.btn_short_cancel_1.setIconSize(QSize(22, 22))
        self.btn_short_cancel_1.setAutoDefault(False)
        self.btn_short_cancel_1.setFlat(False)
        self.frame_short_4 = QFrame(self.MainWinodw2)
        self.frame_short_4.setObjectName(u"frame_short_4")
        self.frame_short_4.setGeometry(QRect(186, 415, 132, 27))
        self.frame_short_4.setFrameShape(QFrame.StyledPanel)
        self.frame_short_4.setFrameShadow(QFrame.Raised)
        self.border_short_4 = QLabel(self.frame_short_4)
        self.border_short_4.setObjectName(u"border_short_4")
        self.border_short_4.setGeometry(QRect(0, 0, 132, 27))
        self.border_short_4.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #E23232;")
        self.label_short_4 = QLabel(self.frame_short_4)
        self.label_short_4.setObjectName(u"label_short_4")
        self.label_short_4.setGeometry(QRect(10, 2, 49, 21))
        self.label_short_4.setFont(font12)
        self.label_short_4.setStyleSheet(u"color:#E23232")
        self.label_sl_short_4 = QLabel(self.frame_short_4)
        self.label_sl_short_4.setObjectName(u"label_sl_short_4")
        self.label_sl_short_4.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_short_4.setFont(font12)
        self.label_sl_short_4.setStyleSheet(u"color:#E23232")
        self.btn_short_cancel_4 = QPushButton(self.frame_short_4)
        self.btn_short_cancel_4.setObjectName(u"btn_short_cancel_4")
        self.btn_short_cancel_4.setGeometry(QRect(107, 2, 23, 23))
        palette12 = QPalette()
        ...
        self.btn_short_cancel_4.setPalette(palette12)
        self.btn_short_cancel_4.setFont(font6)
        self.btn_short_cancel_4.setStyleSheet(u"  background:#00000000")
        self.btn_short_cancel_4.setIcon(icon6)
        self.btn_short_cancel_4.setIconSize(QSize(22, 22))
        self.btn_short_cancel_4.setAutoDefault(False)
        self.btn_short_cancel_4.setFlat(False)
        self.frame_short_3 = QFrame(self.MainWinodw2)
        self.frame_short_3.setObjectName(u"frame_short_3")
        self.frame_short_3.setGeometry(QRect(186, 381, 132, 27))
        self.frame_short_3.setFrameShape(QFrame.StyledPanel)
        self.frame_short_3.setFrameShadow(QFrame.Raised)
        self.border_short_3 = QLabel(self.frame_short_3)
        self.border_short_3.setObjectName(u"border_short_3")
        self.border_short_3.setGeometry(QRect(0, 0, 132, 27))
        self.border_short_3.setStyleSheet(u"border-radius: 4px; \n"
"border:1px solid #E23232;")
        self.label_short_3 = QLabel(self.frame_short_3)
        self.label_short_3.setObjectName(u"label_short_3")
        self.label_short_3.setGeometry(QRect(10, 2, 49, 21))
        self.label_short_3.setFont(font12)
        self.label_short_3.setStyleSheet(u"color:#E23232")
        self.label_sl_short_3 = QLabel(self.frame_short_3)
        self.label_sl_short_3.setObjectName(u"label_sl_short_3")
        self.label_sl_short_3.setGeometry(QRect(71, 2, 30, 21))
        self.label_sl_short_3.setFont(font12)
        self.label_sl_short_3.setStyleSheet(u"color:#E23232")
        self.btn_short_cancel_3 = QPushButton(self.frame_short_3)
        self.btn_short_cancel_3.setObjectName(u"btn_short_cancel_3")
        self.btn_short_cancel_3.setGeometry(QRect(107, 2, 23, 23))
        palette13 = QPalette()
        ...
        self.btn_short_cancel_3.setPalette(palette13)
        self.btn_short_cancel_3.setFont(font6)
        self.btn_short_cancel_3.setStyleSheet(u"  background:#00000000")
        self.btn_short_cancel_3.setIcon(icon6)
        self.btn_short_cancel_3.setIconSize(QSize(22, 22))
        self.btn_short_cancel_3.setAutoDefault(False)
        self.btn_short_cancel_3.setFlat(False)
        ...
        self.spinner_ticker_2.raise_()
        self.spin_stoploss_2.raise_()
        self.label_stoploss_2.raise_()
        self.line_4.raise_()
        self.btn_add_trade.raise_()
        self.label_label_spot_2.raise_()
        self.label_label_spot_3.raise_()
        self.line_5.raise_()
        self.frame_long_1.raise_()
        self.frame_long_2.raise_()
        self.frame_long_3.raise_()
        self.frame_long_4.raise_()
        self.frame_short_2.raise_()
        self.frame_short_1.raise_()
        self.frame_short_4.raise_()
        self.frame_short_3.raise_()
        ...
        self.btn_add_trade.setDefault(False)
        self.btn_long_cancel_1.setDefault(False)
        self.btn_long_cancel_2.setDefault(False)
        self.btn_long_cancel_3.setDefault(False)
        self.btn_long_cancel_5.setDefault(False)
        self.btn_short_cancel_2.setDefault(False)
        self.btn_short_cancel_1.setDefault(False)
        self.btn_short_cancel_4.setDefault(False)
        self.btn_short_cancel_3.setDefault(False)
    ...
    def retranslateUi(self, main):
        ...
        self.label_stoploss_2.setText(QCoreApplication.translate("main", u"Entry Price", None))
        self.btn_add_trade.setText("")
        self.label_label_spot_2.setText(QCoreApplication.translate("main", u"Long", None))
        self.label_label_spot_3.setText(QCoreApplication.translate("main", u"Short", None))
        self.border_long_1.setText("")
        self.label_long_1.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_long_1.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_long_cancel_1.setText("")
        self.border_long_2.setText("")
        self.label_long_2.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_long_2.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_long_cancel_2.setText("")
        self.border_long_3.setText("")
        self.label_long_3.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_long_3.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_long_cancel_3.setText("")
        self.border_long_45.setText("")
        self.label_long_5.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_long_4.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_long_cancel_5.setText("")
        self.border_short_2.setText("")
        self.label_short_2.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_short_2.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_short_cancel_2.setText("")
        self.border_short_1.setText("")
        self.label_short_1.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_short_1.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_short_cancel_1.setText("")
        self.border_short_4.setText("")
        self.label_short_4.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_short_4.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_short_cancel_4.setText("")
        self.border_short_3.setText("")
        self.label_short_3.setText(QCoreApplication.translate("main", u"45632", None))
        self.label_sl_short_3.setText(QCoreApplication.translate("main", u"32", None))
        self.btn_short_cancel_3.setText("")
    # retranslateUi
